...
class XGBWrapper:
    ...
    def evaluate(self, test_x, test_y, categories, category_mapping=None):
        ...
        if category_mapping is not None:
            ...
            mapped_test_y_pred = test_y_pred_series.map(category_mapping).fillna(
                test_y_pred_series
            )
        ...
        for cat, prec, rec, f1 in zip(
            mapped_categories, precision_per_class, recall_per_class, f1_per_class
        ):
